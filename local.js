// var api = "http://loadbalancercasco-1545144343.us-east-2.elb.amazonaws.com/"
var api = "aqui va la ruta"
var place;
var priceTrip = 0;
var BankTerminal;
var typePayment;
...
$(document).ready(function () {
    getMaxSaturation();
    $.get(api + "api/unitTypes", function (unitT) {
        unitT.forEach(function (u) {
            if (u.name == 'Sedan' || u.name == 'SUV')
...
function validate(type) {
    ...
    if (type == "card") {
        ...
        if (dateexp.length < 7) {
            $('#idExpiration').html("Formato de fecha invalido ejemplo 01/2019");
...
function getExpirationDate(date, opc) {
    ...
    if (opc == "month") {
        ...
        return arr[1].substring(2, arr[1].length)
    } else if (opc == "year2") {
        return arr[1]
    }
...
function onError(response) {
    // console.log("error function B======D")
    // console.log(response)
    var message;
